 ...
 */
CKEDITOR.config.format_tags = 'madeup;p;h1;h2;h3;h4;h5;h6;pre;address;div';
 ...
 */
 CKEDITOR.config.format_madeup = { element : 'madeup' };

/**
 * The style definition to be used to apply the "Made up" format.
 * @type Object
 * @default { element : 'madeup' }
 * @example
 * config.format_madeup = { element : 'madeup', attributes : { 'class' : 'madeup' } };
 */
